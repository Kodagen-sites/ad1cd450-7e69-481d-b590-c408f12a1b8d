...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Header />
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 text-ink md:px-8 md:pt-40">
        <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-navy/70">Legal</p>
